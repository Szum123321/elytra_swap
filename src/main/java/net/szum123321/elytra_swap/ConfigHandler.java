...
public class ConfigHandler {
    @Comment(value = "Changes how server treats players without mod installed\n" +
            ...
            "2: for players without Elytra Swap installed armour still will be chnaged when falling but firework usage will be unavailable"
    )
    public int noModPlayersHandlingMethode = 0;
